...
var knowtApp = angular.module('knowtChirpAppV2', ['ngRoute', 'ngAnimate', 'ui.bootstrap']);
knowtApp.header = { title: 'Knowt Chirp V2', help: 'knowtshareHelp.html' };
...
(function (app, fo, undefined) {
    ...
    app.service('workspaceService', ['$log', function ($log) {
        ...
        this.workSpace = function (properties, modelTemplate) {
            ...
            space.traffic = fo.knowtChirpAppV2.newTraffic({}, space);

            space.sessionMenu = fo.knowtChirpAppV2.newMenuSession({}, space);
    ...
    app.controller('workSpace', function ($scope, $log, dialogService, workspaceService) {
        ...
        fo.subscribe('proxyStarted', function (proxy, hub, sessionKey) {
            ...
            $scope.doJoinSession = function () {
                space.sessionMenu.doJoinSession;
            }
